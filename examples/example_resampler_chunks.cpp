...
//   int32_t noInputSamples=128;
//   float inputSamples[noChannels][noInputSamples];
//   int32_t usedInputSamples = noInputSamples; //the buffer should be filled at the first iteration

  
//   int32_t noOutputSamples=128;	// it's not necessary that the input and output buffer have the same length.
//   float outputSamples[noChannels][noOutputSamples];
//   int32_t computedOutputSamples = 0;
...
//     //resampling =========================================
//     int32_t usedInputSamplesCurrentIteration;
//     int32_t computedOutputSamplesCurrentIteration;
